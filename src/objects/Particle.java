...
//   private float blue;
   ...
   protected void reset(boolean explode) {
      ...
      xSpeed = (float)generator.nextInt(4) - 2f;
      ySpeed = (float)1f;
      zSpeed = generator.nextInt(4) - 2f;
      // Assign gravity.
      xGravity = 0f;
      yGravity = 0.01f; // fumaca sobe
      zGravity = 0f;
   }
   ...
   private void resetCommonProperties() {
      ...
      fade = (float) Math.random() * 160f;
      // Initial location for the praticle
      xLocation = 0f;
      yLocation = 0f;
      zLocation = 0f;
   }
   ...
   protected void restart() {
      ...
      Random generator = new Random();
      // Assign direction and speed for this particle.
      xSpeed = (float)generator.nextInt(2) - 1f;
      ySpeed = (float)1f;
      zSpeed = generator.nextInt(2) - 1f;
   }
